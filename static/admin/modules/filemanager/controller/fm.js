...
Ext.define('MyDesktop.modules.filemanager.controller.fm', {
    ...
    mainView: 'MyDesktop.modules.filemanager.view.Win',
    ...
    ,openfile: function(success) {        
        var me = this
            ,win = Ext.create('MyDesktop.modules.filemanager.view.OpenFileDialog');
    ...
    ,newDir: function(win) {//, parent) {
        ...
        D.p('Create a directory', 'New directory name', [], function(t) {
            
            var p = me.getSelectedPath(win)

            Core.Ajax.request({
                url: 'models.fm:newdir',
                params: {name: t, path: p.path},
                succ: function(data) {
                    if(data.filename) {
