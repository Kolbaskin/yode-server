...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    shortcutTpl: [
        '<tpl for=".">',
            '<div class="ux-desktop-shortcut" id="{name}-shortcut">',
                '<div class="ux-desktop-shortcut-icon {iconCls} {iconCls}-32">',
    ...
    onWindowMenuCreateQuickStart: function() {
        var me = this, win = me.windowMenu.theWin
            ,sh = { name: win.title, iconCls: win.iconCls, module: win.id, controller: (win.controllerName || null) }
        ...
        me.taskbar.quickStart.setWidth(me.taskbar.quickStart.width + 32)
    ...
    onWindowMenuCreateShortcut: function() {
        ...
        me.shortcutsView.getStore().add(sh)
